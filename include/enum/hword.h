...
typedef enum GameMode { /* 0x02036dbe */
                        NORMAL = 0,
                        HARD = 1,
                        ULTIMATE = 2
} GameMode;

typedef enum KeyEmulation {
  NONE = 0,
  EMULATE_A = 1,
  EMULATE_B = 2,
  EMULATE_RIGHT = 16,
...
typedef enum MinigameProgress { /* 0x02031930 */
                                PREPARE = 0,
                                IN_GAME = 1,
                                GAME_OVER = 2
} MinigameProgress;
...
typedef enum MissionStatus {
  ...
  FAIL = 8,
  SUCCESS = 16,
  DISABLE_MENU = 64 /* オメガにとどめ刺すとき？ */,
  CUTSCENE = 128
} MissionStatus;

typedef enum SoundID { /* SoundIDの2バイト版 */
                       NONE = 0,
                       UNK_01 = 1,
                       YES = 2 /* 決定音 */,
                       NO = 3 /* キャンセル音 */,
